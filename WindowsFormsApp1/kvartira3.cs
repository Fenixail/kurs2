...
{
    public partial class kvartira3 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DB db = new DB();
            MySqlCommand command = new MySqlCommand("INSERT INTO `3kvart` (FirstName, LastName, city) VALUES(@FName, @LName, @Cit)", db.getConnection());
        ...
        public Boolean isUserExists()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM 3kvart WHERE FirstName= @FN", dataBase.getConnection());
        ...
        {
            int patientId = GetIdFromTable("3kvart", "FirstName", FirstName);
            DB dataBase = new DB();
            string query = "DELETE FROM 3kvart WHERE `id` = @recordId";

            dataBase.openConnection();
            using (MySqlCommand command = new MySqlCommand(query, dataBase.getConnection()))
            {
                command.Parameters.AddWithValue("@recordId", patientId);
