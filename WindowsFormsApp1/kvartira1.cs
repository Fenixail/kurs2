...
{
    public partial class kvartira1 : Form
    {
...

        {
            ...
            DB db = new DB();
            MySqlCommand command = new MySqlCommand("INSERT INTO `1kvart` (FirstName, LastName, city) VALUES(@FName, @LName, @Cit)", db.getConnection());
        ...
        public Boolean isUserExists()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM 1kvart WHERE FirstName= @FN", dataBase.getConnection());
        ...
        {
            int pokupId = GetIdFromTable("1kvart", "FirstName", FirstName);
            DB dataBase = new DB();
            string query = "DELETE FROM 1kvart WHERE `id` = @recordId";
